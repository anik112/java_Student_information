 ...
 * @author anik
 */
public class ElectricalDptList extends javax.swing.JFrame {

    /**
     * Creates new form ElectricalDptList
     */
    public ElectricalDptList() {
        initComponents();
        refreshTable();
    ...
    private void tblShowCurrentInformationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowCurrentInformationMouseClicked
        ...
        ElectricalDptService electricalDptService=new ElectricalDptService(); // create electrical department sercice object

        showStudent.setTitle("Electrical Department"); // set Title in showStudent frame
        ...
        byte[] image = electricalDptService.getImage(Integer.parseInt(model.getValueAt(row, 1).toString()));
    ...
    public void electricalDptDesplayInTable() {
        ...
        ElectricalDptService electricalDptService = new ElectricalDptService();
