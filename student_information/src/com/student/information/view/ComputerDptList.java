 ...
 * @author anik
 */
public class ComputerDptList extends javax.swing.JFrame {

    /**
     * Creates new form ComputerDptList
     */
    public ComputerDptList() {
        initComponents();
        refreshTable();
        this.setTitle("Computer Department");
    }
    ...
    private void initComponents() {
        ...
        lblShowTableHadder.setText("Computer Department All Student List");
    ...
    private void tblShowCurrentInformationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowCurrentInformationMouseClicked
        ...
        ComputerDptService computerDptService=new ComputerDptService(); // create computer department sercice object
        
        showStudent.setTitle("Computer Department"); // set showStudent frame title
        ...
        byte[] image=computerDptService.getImage(Integer.parseInt(model.getValueAt(row, 1).toString()));
    ...
    public void computerDptDesplayInTable() {
        ...
        ComputerDptService computerDptService = new ComputerDptService();
