 ...
 * @author anik
 */
public class CivilDptList extends javax.swing.JFrame {

    /**
     * Creates new form CivilDptList
     */
    public CivilDptList() {
        initComponents();
        refreshTable();
    ...
    private void tblShowCurrentInformationMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblShowCurrentInformationMouseClicked
        ...
        CivilDptService civilDptService=new CivilDptService(); // create civil department sercice object

        showStudent.setTitle("Civil Department"); // set Title in showStudent frame
        ...
        byte[] image = civilDptService.getImage(Integer.parseInt(model.getValueAt(row, 1).toString()));
    ...
    public void civilDptDesplayInTable() {
        ...
        CivilDptService civilDptService = new CivilDptService();
