...
public class ElectricalDpt {
    ...
    public ElectricalDpt() {
    }

    public ElectricalDpt(int student_id, String student_fst_name, String student_sur_name, String date_of_birth, String gander, String email, String number, String present_address, String permanent_address, String house_no, int post_code, int dpt_code) {
